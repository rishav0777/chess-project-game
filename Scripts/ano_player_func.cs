...
public class ano_player_func : MonoBehaviour
{
    ...
    public void highlight_knight(int row, int colm)
    {
       ...
       // print("knight1" + initialise_Player.playerPosition[row + 1, colm + 2]);
        ...
        else if (row + 2 < 8 && colm + 1 < 8 && initialise_Player.playerPosition[row + 2, colm + 1].Substring(0, 5) == "white")
        {
        ...
        else if (row + 2 < 8 && colm - 1 >= 0 && initialise_Player.playerPosition[row + 2, colm - 1].Substring(0, 5) == "white")
        {
            chess_Grid.Grid_vector[row + 2, colm - 1].transform.GetComponent<SpriteRenderer>().color = Color.red;
        }
        ...
        else if (row - 2 >= 0 && colm + 1 < 8 && initialise_Player.playerPosition[row - 2, colm + 1].Substring(0, 5) == "white")
        {
            chess_Grid.Grid_vector[row - 2, colm + 1].transform.GetComponent<SpriteRenderer>().color = Color.red;
        }
        ...
        else if (row - 2 >= 0 && colm - 1 >= 0 && initialise_Player.playerPosition[row - 2, colm - 1].Substring(0, 5) == "white")
        {
            chess_Grid.Grid_vector[row - 2, colm - 1].transform.GetComponent<SpriteRenderer>().color = Color.red;
        }
        ...
        else if (row + 1 < 8 && colm + 2 < 8 && initialise_Player.playerPosition[row + 1, colm + 2].Substring(0, 5) == "white")
        {
        ...
        else if (row + 1 < 8 && colm - 2 >= 0 && initialise_Player.playerPosition[row + 1, colm - 2].Substring(0, 5) == "white")
        {
            chess_Grid.Grid_vector[row + 1, colm - 2].transform.GetComponent<SpriteRenderer>().color = Color.red;
        }
        ...
        else if (row - 1 >= 0 && colm + 2 < 8 && initialise_Player.playerPosition[row - 1, colm + 2].Substring(0, 5) == "white")
        {
            chess_Grid.Grid_vector[row - 1, colm + 2].transform.GetComponent<SpriteRenderer>().color = Color.red;
        }
        ...
        else if (row - 1 >= 0 && colm - 2 >= 0 && initialise_Player.playerPosition[row - 1, colm - 2].Substring(0, 5) == "white")
        {
            chess_Grid.Grid_vector[row - 1, colm - 2].transform.GetComponent<SpriteRenderer>().color = Color.red;
        }
    ...
    public void highlight_king(int row, int colm)
    {
        ...
        for (int i = -1; i <= 1; i++)
        {
            for (int j = -1; j <= 1; j++)
            {
                ...
                else if (r < 8 && c < 8 && c >= 0 && r >= 0 && initialise_Player.playerPosition[r, c].Substring(0, 5) == "white")
                {
    ...
    public void highlight_pawn(int row, int colm)
    {
        ...
        if (row < 8 && colm - 1 >= 0 && initialise_Player.playerPosition[row, colm - 1] == "blank")
        {
            chess_Grid.Grid_vector[row, colm - 1].transform.GetChild(1).gameObject.SetActive(true);
        }
        if ((row - 1 >= 0 && colm - 1 >= 0) && initialise_Player.playerPosition[row - 1, colm - 1].Substring(0, 5) == "white")
        {
            chess_Grid.Grid_vector[row - 1, colm - 1].transform.GetComponent<SpriteRenderer>().color = Color.red;
        }
        if ((row + 1 < 8 && colm - 1 >= 0) && initialise_Player.playerPosition[row + 1, colm - 1].Substring(0, 5) == "white")
        {
            chess_Grid.Grid_vector[row + 1, colm - 1].transform.GetComponent<SpriteRenderer>().color = Color.red;
        }
    ...
    public void check_digonally(int row, int colm)
    {
        ...
        for (int i = row + 1, j = colm + 1; i < 8 && j < 8; i++, j++)
        {
            ...
            else if (initialise_Player.playerPosition[i, j].Substring(0, 5) == "white")
            {
    ...
    public void check_vertically_horizantally(int row, int colm)
    {
        ...
        for (int i = row + 1; i < 8; i++)
        {
            ...
            else if (initialise_Player.playerPosition[i, colm].Substring(0, 5) == "white")
            {
        ...
        for (int i = colm + 1; i < 8; i++)
        {
            ...
            else if (initialise_Player.playerPosition[row, i].Substring(0, 5) == "white")
            {
    ...
    public void select_player(int r, int c)
    {
        ...
        if (initialise_Player.playerPosition[r, c].Substring(0, 5) == "black")
        {
            selected_playerCol = c; selected_playerRow = r;
            players_Function.neutralise_selectedPlayer();
        }
    ...
    public void player_movements(int r, int c, int row, int colm)
    {
       // print(" " + r + " " + c + " " + row + " " + colm);
        ...
        if (r == initialise_Player.getBlackX() && c == initialise_Player.getBlackY())
        {
            initialise_Player.setBlackX(row); initialise_Player.setBlackY(colm);
        }

        
        int rr = initialise_Player.getBlackX(), cc = initialise_Player.getBlackY();
